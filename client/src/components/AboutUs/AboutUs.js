...
import cuong from "../../assets/images/cuong.jpg";
import giang from "../../assets/images/giangg.jpg";
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-sm-6 col-md-4">
              ...
              >
                <div className="pt-2 text-center gg">
                  <img className="img-fluid1" src={cuong} alt="" />
                  <h4 className="na-2">Tô Văn Cương</h4>
            ...
            <div className="col-sm-6 col-md-4">
              ...
              >
                <div className="pt-2 text-center gg">
                  <img className="img-fluid1" src={na} alt="" />
                  <h4 className="na-2">Nguyễn Hoàng Ly Na</h4>
                  <p className="na-2">Thành viên</p>
                </div>
              </div>
            </div>
            <div className="col-sm-6 col-md-4">
              ...
              >
                <div className="pt-2 text-center gg">
                  <img className="img-fluid1" src={duong} alt="" />
                  <h4 className="na-2">Đoàn Đại Dương</h4>
                  <p className="na-2">Thành viên</p>
                </div>
              </div>
            </div>
            <div className="col-sm-6 col-md-4">
              ...
              >
                <div className="pt-2 text-center gg">
                  <img className="img-fluid1" src={giang} alt="" />

                  <h4 className="na-2">Nguyễn Thị Bích Giang</h4>
                  <p className="na-2">Thành viên</p>
                </div>
              </div>
            </div>
